...
public class AgregarPersonasEquipo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/admin/agregarPersonasEquipo.jsp").forward(request, response);
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	 ...
	 try{
		if(request.getSession().getAttribute("editarEntrenador")!=null){
			...
			Equipo equipo = (Equipo)request.getSession().getAttribute("editarEntrenador");
