					...
					<thead>
						...
						<tr>
							...
							<td><input align="center" type="text" name="usuario"
								id="usuario" value="<%=usuario.equals("null")?"":usuario%>" class="form-control" placeholder="usuario..." required="" /></td>
						</tr>

						<tr>
							<td>ContraseÒa:</td>
							<td><input align="center" type="text" name="contraseÒa"
								id="contraseÒa" value="<%=contraseÒa.equals("null")?"":contraseÒa%>" class="form-control" placeholder=contraseÒa..." required="" /></td>
						</tr>
